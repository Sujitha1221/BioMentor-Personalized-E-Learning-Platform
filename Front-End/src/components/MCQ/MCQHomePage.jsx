...
import { FaChartBar, FaQuestionCircle, FaHistory } from "react-icons/fa";
...
const MCQHomePage = () => {
  ...
  return (
    <div className="p-12 md:p-20 bg-gradient-to-br from-gray-100 to-gray-50 min-h-screen flex flex-col items-center gap-20 md:mt-5">
      {/* Start Quiz Section */}
